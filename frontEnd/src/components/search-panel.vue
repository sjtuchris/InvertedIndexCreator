    ...
    <div>
       ...
       <!--  getindex是自定义事件 -->
        ...
        <div class="search-input">
            ...
            <input type="text" v-model="keyword" @keydown.enter="search()" @keydown.down="selectDown()" @keydown.up.prevent="selectUp()">
            <!-- 这是一个小叉叉，点击它可清除输入框内容 -->
...
export default {
    ...
    data: function() {
        return {
            ...
            logoData: [{
                name: '360搜索',
                searchSrc: 'http://localhost:8888/query?'
            }, {
                name: '百度搜索',
    ...
    methods: {
        ...
        search: function() {
            //打开对应的搜索界面
            // this.$http.jsonp(this.logoData[this.searchIndex].searchSrc + this.keyword).then(response => {
